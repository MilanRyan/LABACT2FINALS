...
//Ryan Joshua F. Milan
//Comments
//The `MyFinalsActivity2` contract demonstrates Ether management and ownership control in a Solidity smart contract. 
//It initializes with an owner and a fixed Ether amount, accepts Ether via the `receive()` function, and enables the owner to send Ether to recipients.